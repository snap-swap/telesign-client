...
object EnumPhoneTypes extends Enumeration {
  ...
  protected case class PhoneTypeValue(code: Int, risk: EnumRisks.Risk, action: EnumActions.Action, label: String) extends super.Val() {
    override def toString(): String =
      s"[$code] $label, $risk risk, $action recommended action"
  }
  ...
  /**
    ...
    */
  val FixedLine = PhoneTypeValue(1, Low, Allow, "Fixed line")
  /**
    ...
    */
  val Mobile = PhoneTypeValue(2, MediumLow, Allow, "Mobile")
  /**
    ...
    */
  val PrePaidMobile = PhoneTypeValue(3, MediumHigh, Flag, "Pre-paid mobile")
  /**
    ...
    */
  val TollFree = PhoneTypeValue(4, High, Block, "Toll-free")
  /**
    ...
    */
  val NonFixedVOIP = PhoneTypeValue(5, High, Block, "Non-fixed VOIP")
  /**
    ...
    */
  val Pager = PhoneTypeValue(6, High, Block, "Pager")
  /**
    ...
    */
  val Payphone = PhoneTypeValue(7, High, Block, "Payphone")
  /**
    * The telephone number entered is not a valid number.
    */
  val Invalid = PhoneTypeValue(8, High, Block, "Invalid")
  /**
    ...
    * - Short Code
    */
  val RestrictedNumber = PhoneTypeValue(9, High, Block, "Restricted")
  /**
    ...
    */
  val Personal = PhoneTypeValue(10, MediumLow, Allow, "Personal")
  /**
    ...
    */
  val Voicemail = PhoneTypeValue(11, MediumHigh, Block, "Voicemail")
  /**
    ...
    */
  val Other = PhoneTypeValue(20, MediumHigh, Block, "Other")
